      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-[1400px]">
        <div className="flex flex-col lg:flex-row gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="w-full lg:w-[35%] text-center lg:text-left">
            ...
            >
              <h2 className="text-[32px] sm:text-4xl md:text-5xl lg:text-[56px] font-[900] text-white leading-[1.15] md:leading-[1.1] mb-4 md:mb-6">
                Explore Our <br className="hidden sm:block" /> Courses
              </h2>
              <p className="text-gray-300 text-[13px] sm:text-[14px] md:text-[15px] leading-relaxed mb-8 md:mb-10 max-w-lg mx-auto lg:mx-0 px-2 lg:px-0">
              ...
              <Link 
                to="/courses"
                className="inline-block bg-[#F23B4E] hover:bg-[#D92B3E] text-white px-8 md:px-10 py-3 md:py-3.5 rounded-none font-bold text-[13px] md:text-[14px] uppercase tracking-wider transition-colors duration-300 shadow-lg shadow-[#F23B4E]/30"
              >
                View More
              </Link>
            </motion.div>
                ...
                {courses.map((course) => (
                  <div key={course.id} className="relative aspect-[4/5] md:aspect-[3/4] rounded-none overflow-hidden group">
                    ...
                    <div className="absolute bottom-0 left-0 w-full p-4 md:p-6 text-center">
                      <h3 className="text-white font-medium text-[13px] sm:text-[15px] md:text-[18px] lg:text-[20px] leading-snug drop-shadow-md px-1">
                        {course.subtitle}
                      </h3>
                    </div>
                  </div>
